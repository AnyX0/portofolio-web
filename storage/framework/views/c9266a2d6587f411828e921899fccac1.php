            ...
            <div class="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl shadow-black/30">
                ...
                <div class="relative p-8 z-10">
                    <div class="flex items-center gap-3 mb-4 text-sm text-slate-400">
                        ...
                        <span>•</span>
                        <span><?php echo e(optional($project->published_at)->format('d M Y') ?? 'Draft mode'); ?></span>
                    </div>
                            ...
                            <div class="swiper-wrapper h-full w-full">
                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide w-full h-full">
                                        <img src="<?php echo e($image); ?>" alt="Project image" class="w-full h-full object-cover">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
        ...
        <aside class="space-y-4">
            <div class="rounded-3xl border border-white/10 bg-white/5 p-6 space-y-3 transition hover:-translate-y-0.5 hover:shadow-xl">
                ...
                <dl class="space-y-2 text-sm text-slate-200">
                    <div class="flex justify-between border-b border-white/5 pb-2">
                        <dt>Stack</dt>
                        <dd class="text-right"><?php echo e($project->tech_stack ?? 'TBD'); ?></dd>
                    </div>
                    <div class="flex justify-between border-b border-white/5 pb-2">
                        <dt>Status</dt>
                        <dd class="text-right"><?php echo e($project->is_published ? 'Live' : 'Draft'); ?></dd>
                    </div>
                    <div class="flex justify-between border-b border-white/5 pb-2">
                        <dt>Diterbitkan</dt>
                        <dd class="text-right"><?php echo e(optional($project->published_at)->format('d M Y') ?? 'Belum'); ?></dd>
                    </div>
                </dl>
            ...
            <div class="rounded-3xl border border-white/10 bg-white/5 p-6 flex flex-col gap-3 text-sm text-slate-200">
                <?php if($project->live_url): ?>
                    <a href="<?php echo e($project->live_url); ?>" class="inline-flex items-center justify-between px-4 py-3 rounded-2xl bg-emerald-400/10 border border-emerald-400/30 text-emerald-100 hover:bg-emerald-400/15 transition" target="_blank">
                        <span>Open Live</span>
                        <span>↗</span>
                    </a>
                <?php endif; ?>
                <?php if($project->repo_url): ?>
                    <a href="<?php echo e($project->repo_url); ?>" class="inline-flex items-center justify-between px-4 py-3 rounded-2xl bg-white/5 border border-white/10 hover:border-white/30 transition" target="_blank">
                        <span>Source Code</span>
                        <span>↗</span>
                    </a>
                <?php endif; ?>
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center justify-between px-4 py-3 rounded-2xl bg-white/5 border border-white/10 hover:border-white/30 transition">
                    <span>Kembali</span>
                    <span>←</span>
                </a>
            </div>
...
<?php endif; ?>
<?php /**PATH E:\Andi\Documents\Kuliah\PEMROGRAMAN MOBILE - SMT5\StudioProjects\project_uas\resources\views/portfolio/show.blade.php ENDPATH**/ ?>