        ...
        <?php else: ?>
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <a href="<?php echo e(route('project.show', $project->slug)); ?>" class="group relative rounded-3xl border border-white/10 bg-white/5 overflow-hidden shadow-lg shadow-black/20 transition hover:-translate-y-0.5 hover:shadow-xl hover:border-white/20 flex flex-col">
                        ...
                        <?php if(!empty($projectImages)): ?>
                            <div class="relative h-48 bg-slate-900/50 overflow-hidden">
                                <div class="swiper-container h-full project-slider-<?php echo e($loop->index); ?>">
                                    <div class="swiper-wrapper">
                                        <?php $__currentLoopData = $projectImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="swiper-slide">
                                                <img src="<?php echo e($image); ?>" alt="<?php echo e($project->title); ?>" class="w-full h-full object-cover">
                                            </div>
                        ...
                        <div class="p-6 flex flex-col gap-4 flex-1">
                            <div class="flex items-center justify-between">
                                <p class="text-xs uppercase tracking-[0.2em] text-slate-400"><?php echo e(optional($project->published_at)->format('M Y') ?? 'Draft'); ?></p>
                                <span class="px-3 py-1 rounded-full text-[11px] border <?php echo e($project->is_published ? 'border-emerald-400/40 text-emerald-200 bg-emerald-400/10' : 'border-amber-400/40 text-amber-200 bg-amber-400/10'); ?>">
                                    <?php echo e($project->is_published ? 'Published' : 'Draft'); ?>

                                </span>
                            </div>
                            
                            <h3 class="text-xl font-semibold text-white leading-tight"><?php echo e($project->title); ?></h3>
                            <p class="text-sm text-slate-300 leading-relaxed line-clamp-3"><?php echo e($project->summary); ?></p>
                            ...
                            <?php if($project->tech_stack): ?>
                                <div class="flex flex-wrap gap-2 text-[12px]">
                                    <?php $__currentLoopData = explode(',', $project->tech_stack); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-slate-200"><?php echo e(trim($tech)); ?></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH E:\Andi\Documents\Kuliah\PEMROGRAMAN MOBILE - SMT5\StudioProjects\project_uas\resources\views/portfolio/index.blade.php ENDPATH**/ ?>