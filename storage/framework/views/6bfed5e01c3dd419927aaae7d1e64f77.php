...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Console']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Console']); ?>
        ...
        <div class="rounded-2xl border border-white/10 bg-white/5 p-6 hover:bg-white/10 transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-semibold text-white"><?php echo e($totalCount); ?></p>
                </div>
        ...
        <div class="rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-6 hover:bg-emerald-500/20 transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-semibold text-emerald-300"><?php echo e($publishedCount); ?></p>
                </div>
        ...
        <div class="rounded-2xl border border-amber-400/20 bg-amber-500/10 p-6 hover:bg-amber-500/20 transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-semibold text-amber-200"><?php echo e($draftCount); ?></p>
                </div>
        ...
        <div class="rounded-2xl border border-indigo-400/20 bg-indigo-500/10 p-6 hover:bg-indigo-500/20 transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-semibold text-indigo-300"><?php echo e($recentCount); ?></p>
                </div>
    ...
    <div class="mb-8">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <a href="<?php echo e(route('admin.projects.index')); ?>" class="p-6 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-cyan-400/40 transition group">
            ...
            <a href="<?php echo e(route('admin.projects.create')); ?>" class="p-6 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-emerald-400/40 transition group">
                <div class="flex items-center gap-4">
    ...
    <div>
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('admin.projects.index')); ?>" class="text-sm text-cyan-300 hover:text-cyan-200">Lihat Semua →</a>
        </div>
        <div class="overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur">
            <table class="min-w-full text-sm text-slate-200">
                ...
                <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $projects->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-t border-white/5 hover:bg-white/5 transition">
                        <td class="px-4 py-3 font-medium text-white"><?php echo e($project->title); ?></td>
                        ...
                        <td class="px-4 py-3 text-center"><?php echo e($project->created_at->format('d M Y')); ?></td>
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                <!-- Edit -->
                                <a href="<?php echo e(route('admin.projects.edit', $project)); ?>" class="p-2 rounded-lg hover:bg-amber-500/10 text-amber-400 hover:text-amber-300 transition-all group" title="Edit">
                                ...
                                <!-- Archive -->
                                <button onclick="archiveProject(<?php echo e($project->id); ?>)" class="p-2 rounded-lg hover:bg-blue-500/10 text-blue-400 hover:text-blue-300 transition-all group" title="Arsipkan">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Share -->
                                <button onclick="shareProject(<?php echo e($project->id); ?>, '<?php echo e($project->title); ?>')" class="p-2 rounded-lg hover:bg-indigo-500/10 text-indigo-400 hover:text-indigo-300 transition-all group" title="Bagikan">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Delete -->
                                <form method="POST" action="<?php echo e(route('admin.projects.destroy', $project)); ?>" class="inline delete-form-<?php echo e($project->id); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button" onclick="deleteProject(<?php echo e($project->id); ?>, document.querySelector('.delete-form-<?php echo e($project->id); ?>'))" class="p-2 rounded-lg hover:bg-rose-500/10 text-rose-400 hover:text-rose-300 transition-all group" title="Hapus">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH E:\Andi\Documents\Kuliah\PEMROGRAMAN MOBILE - SMT5\StudioProjects\portofolio-web\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>