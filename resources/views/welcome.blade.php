    ...
    <section class="relative min-h-[80vh] flex items-center justify-center">
        ...
        <div class="relative text-center space-y-8 max-w-4xl">
            ...
            <div class="flex flex-wrap justify-center gap-4 animate-fade-in-up animation-delay-400">
                <a href="{{ route('projects') }}" class="group px-8 py-4 rounded-full bg-gradient-to-r from-cyan-500 to-indigo-500 text-white font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/40 transition-all hover:scale-105">
                ...
                <a href="{{ route('about') }}" class="px-8 py-4 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 text-slate-200 font-semibold hover:bg-white/10 transition-all hover:scale-105">
                    Tentang Saya
                </a>
            </div>
