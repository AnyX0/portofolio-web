        ...
        @else
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                @foreach($projects as $project)
                    ...
                    @endphp
                    <a href="{{ route('project.show', $project->slug) }}" class="group relative rounded-3xl border border-white/10 bg-white/5 overflow-hidden shadow-lg shadow-black/20 transition hover:-translate-y-1 hover:shadow-2xl hover:border-white/20 flex flex-col">
