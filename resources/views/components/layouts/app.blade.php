    ...
    <div class="relative">
        <header class="px-6 py-8 max-w-6xl mx-auto flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-4 text-sm text-slate-300">
                <a href="{{ route('home') }}" class="hover:text-white transition {{ request()->routeIs('home') ? 'text-white' : '' }}">Home</a>
                <a href="{{ route('projects') }}" class="hover:text-white transition {{ request()->routeIs('projects') ? 'text-white' : '' }}">Projects</a>
                <a href="{{ route('about') }}" class="hover:text-white transition {{ request()->routeIs('about') ? 'text-white' : '' }}">Tentang</a>
        ...
        <footer class="px-6 pb-10 max-w-6xl mx-auto text-xs text-slate-500 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.login') }}" class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-slate-200 text-[11px] font-mono hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/30 transition">
                    <span class="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                    Admin
                </a>
            </div>
