        ...
        <div class="rounded-2xl border border-white/10 bg-white/5 p-6 hover:bg-white/10 transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-semibold text-white">{{ $projects->total() }}</p>
                </div>
            ...
            <table class="min-w-full text-sm text-slate-200">
                ...
                @forelse($projects->take(5) as $project)
                    <tr class="border-t border-white/5 hover:bg-white/5 transition">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('admin.projects.edit', $project) }}" class="text-cyan-300 hover:text-cyan-200 text-xs font-medium">Edit</a>
                        </td>
                    </tr>
                @empty
